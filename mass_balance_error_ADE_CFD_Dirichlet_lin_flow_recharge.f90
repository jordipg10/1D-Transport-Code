function mass_balance_error_ADE_CFD_Dirichlet_lin_flow_recharge(this,conc_old,conc_new,Delta_t,Delta_x) result(mass_bal_err)
    ...
    print *, (this%tpt_props_heterog%flux(1)-this%BCs%flux_inf)*(this%BCs%conc_inf-this%conc(1)) - (this%tpt_props_heterog%flux(n)-this%BCs%flux_out)*(this%BCs%conc_out-this%conc(n))
end function