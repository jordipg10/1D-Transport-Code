...
!    type(tridiag_sym_matrix_c), target :: A_mat_sym
!    type(tridiag_matrix_c), target :: A_mat_non_sym
!    !select type (this)
...
!            A_mat_sym%diag=trans_mat%diag/this%F_mat%diag
!            A_mat_sym%sub=trans_mat%sub
!            A_mat=>A_mat_sym
!        type is (tridiag_matrix_c)
!            A_mat_non_sym%diag=trans_mat%diag/this%F_mat%diag
!            A_mat_non_sym%sub=trans_mat%sub
!            A_mat_non_sym%super=trans_mat%super
!            A_mat=>A_mat_non_sym
!        end select
!        
