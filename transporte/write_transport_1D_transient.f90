...
subroutine write_transport_1D_transient(this,Time_out,output)
    ...
    if (this%time_discr%int_method==1 .or. this%time_discr%int_method==2) then
    ...
    else if (this%time_discr%int_method==5) then
    ...
    write(1,"(/,2x,'Matrix B:'/)") 
    write(1,"(17x,2F15.5)") this%B_mat%diag(1), this%B_mat%super(1)    
    do i=2,this%spatial_discr%Num_targets-1
        write(1,"(2x,3F15.5)") this%B_mat%sub(i-1), this%B_mat%diag(i), this%B_mat%super(i)
    end do
    write(1,"(2x,2F15.5/)") this%B_mat%sub(this%spatial_discr%Num_targets-1), this%B_mat%diag(this%spatial_discr%Num_targets)
    write(1,"(/,2x,'Vector f:'/)")
