...
! Boundary conditions
    call my_BCs%read_BCs("C:\Users\user2319\source\repos\jordipg10\1D-Transport-Code\input\BCs.dat")
    if (my_BCs%BCs_label(1)==1 .and. my_BCs%BCs_label(2)==1) then
        call my_BCs%read_Dirichlet_BCs("C:\Users\user2319\source\repos\jordipg10\1D-Transport-Code\input\Dirichlet_BCs.dat")
        call my_BCs%read_flux_inf("C:\Users\user2319\source\repos\jordipg10\1D-Transport-Code\input\flux_inflow.dat")
    else if (my_BCs%BCs_label(1)==3) then
        call my_BCs%read_Robin_BC_inflow("C:\Users\user2319\source\repos\jordipg10\1D-Transport-Code\input\Robin_BC_inflow.dat")
    end if
    call this%set_BCs(my_BCs)
 ! Uniform mesh
    my_mesh=>my_homog_mesh
    call my_mesh%read_mesh("C:\Users\user2319\source\repos\jordipg10\1D-Transport-Code\input\Delta_x_homog.dat")
...
! Transport properties
    call my_props_tpt%read_props("C:\Users\user2319\source\repos\jordipg10\1D-Transport-Code\input\tpt_props.dat",this%spatial_discr)
    if (my_props_tpt%source_term_order==0) then
        ...
        open(unit=2,file='C:\Users\user2319\source\repos\jordipg10\1D-Transport-Code\input\flux_coeffs.dat',status='old',action='read')
        read(2,*) flux_ord
