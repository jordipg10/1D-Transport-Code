function mass_balance_error_ADE_CFD_Dirichlet_lin_flow_evap(this,conc_old,conc_new,Delta_t,Delta_x) result(mass_bal_err)
    ...
    real(kind=8) :: sum_time,inf_term,out_term
    integer(kind=4) :: i,n
    ...
    mass_bal_err=sum_time-inf_term-out_term
    
    print *, (this%tpt_props_heterog%flux(1)-this%BCs%flux_inf)*(this%BCs%conc_inf-conc_old(1)) - (this%tpt_props_heterog%flux(n)-this%BCs%flux_out)*(this%BCs%conc_out-conc_old(n))
end function