        !COMPILER-GENERATED INTERFACE MODULE: Thu Aug 14 18:29:24 2025
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE MASS_BALANCE_ERROR_ADE_TRANS_PMF_RECHARGE__genmod
          INTERFACE 
            FUNCTION MASS_BALANCE_ERROR_ADE_TRANS_PMF_RECHARGE(THIS,    &
     ...
     &          TRANSPORT_1D_TRANSIENT_C
            ...
            END FUNCTION MASS_BALANCE_ERROR_ADE_TRANS_PMF_RECHARGE
          END INTERFACE 
        END MODULE MASS_BALANCE_ERROR_ADE_TRANS_PMF_RECHARGE__genmod
